        ...
        <div className="relative pt-32 pb-20 overflow-hidden bg-background">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
                ...
                >
                    ...
                    <h1 className="text-4xl md:text-7xl font-bold font-heading mb-8 bg-clip-text text-transparent bg-gradient-to-r from-primary via-blue-600 to-secondary dark:from-white dark:via-blue-400 dark:to-secondary">
